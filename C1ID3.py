...
id3.fit(train.drop(['Drought Classification'],axis=1),train['Drought Classification'])
...
plt.title('Classifier 1 ID3 Confusion Matrix, Accuracy=%f, Precision=%f, Recall=%f'%(accuracy,precision,recall))
plt.show()
